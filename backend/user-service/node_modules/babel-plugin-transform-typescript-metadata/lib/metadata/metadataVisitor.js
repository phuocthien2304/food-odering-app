...
function metadataVisitor(classPath, path) {
  ...
  switch (field.type) {
    case 'ClassMethod':
      ...
      decorators.push(createMetadataDesignDecorator('design:paramtypes', _core.types.arrayExpression(field.params.map(param => (0, _serializeType.serializeType)(classPath, param)))));
