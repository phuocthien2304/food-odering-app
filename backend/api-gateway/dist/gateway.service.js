...
var GatewayService = (_dec = Injectable(), _dec2 = Reflect.metadata("design:type", Function), _dec3 = Reflect.metadata("design:paramtypes", []), _dec(_class = _dec2(_class = _dec3(_class = /*#__PURE__*/function () {
  ...
  return _createClass(GatewayService, [{
      ...
      var _addMenuItem = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee11(restaurantId, menuItemDto) {
        return _regenerator().w(function (_context11) {
          while (1) switch (_context11.n) {
            case 0:
              return _context11.a(2, this.proxyRequest('restaurant', 'POST', "/api/restaurants/".concat(restaurantId, "/menu"), menuItemDto));
          }
        }, _callee11, this);
      }));
    ...
    key: "deleteMenuItem",
    value: function () {
      var _deleteMenuItem = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee12(menuItemId) {
        return _regenerator().w(function (_context12) {
          while (1) switch (_context12.n) {
            case 0:
              return _context12.a(2, this.proxyRequest('restaurant', 'DELETE', "/api/restaurants/menu/".concat(menuItemId)));
          }
        }, _callee12, this);
      }));
    ...
    value: function () {
      var _createRestaurant = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee13(restaurantDto) {
        return _regenerator().w(function (_context13) {
          while (1) switch (_context13.n) {
            case 0:
              return _context13.a(2, this.proxyRequest('restaurant', 'POST', '/api/restaurants', restaurantDto));
          }
        }, _callee13, this);
      }));
    ...
    value: function () {
      var _getRestaurantsAdmin = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee14() {
        return _regenerator().w(function (_context14) {
          while (1) switch (_context14.n) {
            case 0:
              return _context14.a(2, this.proxyRequest('restaurant', 'GET', '/api/restaurants?admin=true'));
          }
        }, _callee14, this);
      }));
    ...
    value: function () {
      var _toggleRestaurantStatus = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee15(restaurantId, isActive) {
        return _regenerator().w(function (_context15) {
          while (1) switch (_context15.n) {
            case 0:
              return _context15.a(2, this.proxyRequest('restaurant', 'PATCH', "/api/restaurants/".concat(restaurantId, "/status"), {
                isActive: isActive
              }));
          }
        }, _callee15, this);
    ...
    key: "createOrder",
    value: function () {
      var _createOrder = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee16(orderDto) {
        return _regenerator().w(function (_context16) {
          while (1) switch (_context16.n) {
            case 0:
              return _context16.a(2, this.proxyRequest('order', 'POST', '/api/orders', orderDto));
          }
        }, _callee16, this);
      }));
    ...
    key: "getOrder",
    value: function () {
      var _getOrder = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee17(orderId) {
        return _regenerator().w(function (_context17) {
          while (1) switch (_context17.n) {
            case 0:
              return _context17.a(2, this.proxyRequest('order', 'GET', "/api/orders/".concat(orderId)));
          }
        }, _callee17, this);
      }));
    ...
    value: function () {
      var _getCustomerOrders = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee18(customerId) {
        return _regenerator().w(function (_context18) {
          while (1) switch (_context18.n) {
            case 0:
              return _context18.a(2, this.proxyRequest('order', 'GET', "/api/orders/customer/".concat(customerId)));
          }
        }, _callee18, this);
      }));
    ...
    key: "confirmOrder",
    value: function () {
      var _confirmOrder = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee19(orderId) {
        return _regenerator().w(function (_context19) {
          while (1) switch (_context19.n) {
            case 0:
              return _context19.a(2, this.proxyRequest('order', 'PATCH', "/api/orders/".concat(orderId, "/confirm"), {}));
          }
        }, _callee19, this);
      }));
      ...
      var _initiatePayment = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee21(paymentDto) {
        return _regenerator().w(function (_context21) {
          while (1) switch (_context21.n) {
            case 0:
              return _context21.a(2, this.proxyRequest('payment', 'POST', '/api/payments/initiate', paymentDto));
          }
        }, _callee21, this);
      }));
    ...
    key: "getPayment",
    value: function () {
      var _getPayment = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee22(paymentId) {
        return _regenerator().w(function (_context22) {
          while (1) switch (_context22.n) {
            case 0:
              return _context22.a(2, this.proxyRequest('payment', 'GET', "/api/payments/".concat(paymentId)));
          }
        }, _callee22, this);
      }));
    ...
    value: function () {
      var _handlePaymentCallback = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee23(paymentId, callbackData) {
        return _regenerator().w(function (_context23) {
          while (1) switch (_context23.n) {
            case 0:
              return _context23.a(2, this.proxyRequest('payment', 'POST', "/api/payments/".concat(paymentId, "/callback"), callbackData));
          }
        }, _callee23, this);
      }));
      function handlePaymentCallback(_x27, _x28) {
    ...
    key: "retryPayment",
    value: function () {
      var _retryPayment = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee24(paymentId) {
        return _regenerator().w(function (_context24) {
          while (1) switch (_context24.n) {
            case 0:
              return _context24.a(2, this.proxyRequest('payment', 'PATCH', "/api/payments/".concat(paymentId, "/retry"), {}));
          }
        }, _callee24, this);
      }));
      function retryPayment(_x29) {
    ...
    key: "refundPayment",
    value: function () {
      var _refundPayment = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee25(paymentId, reason) {
        return _regenerator().w(function (_context25) {
          while (1) switch (_context25.n) {
            case 0:
              return _context25.a(2, this.proxyRequest('payment', 'POST', "/api/payments/".concat(paymentId, "/refund"), {
                reason: reason
              }));
          }
        }, _callee25, this);
      }));
      function refundPayment(_x30, _x31) {
    ...
    key: "getDelivery",
    value: function () {
      var _getDelivery = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee26(deliveryId) {
        return _regenerator().w(function (_context26) {
          while (1) switch (_context26.n) {
            case 0:
              return _context26.a(2, this.proxyRequest('delivery', 'GET', "/api/deliveries/".concat(deliveryId)));
          }
        }, _callee26, this);
      }));
      function getDelivery(_x32) {
      ...
      var _getDeliveryByOrder = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee27(orderId) {
        return _regenerator().w(function (_context27) {
          while (1) switch (_context27.n) {
            case 0:
              return _context27.a(2, this.proxyRequest('delivery', 'GET', "/api/deliveries/order/".concat(orderId)));
          }
        }, _callee27, this);
      }));
      function getDeliveryByOrder(_x33) {
    ...
    key: "createDelivery",
    value: function () {
      var _createDelivery = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee28(orderData) {
        return _regenerator().w(function (_context28) {
          while (1) switch (_context28.n) {
            case 0:
              return _context28.a(2, this.proxyRequest('delivery', 'POST', '/api/deliveries', orderData));
          }
        }, _callee28, this);
      }));
      function createDelivery(_x34) {
    ...
    key: "startDelivery",
    value: function () {
      var _startDelivery = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee29(deliveryId, data) {
        return _regenerator().w(function (_context29) {
          while (1) switch (_context29.n) {
            case 0:
              return _context29.a(2, this.proxyRequest('delivery', 'POST', "/api/deliveries/".concat(deliveryId, "/start"), data));
          }
        }, _callee29, this);
      }));
      function startDelivery(_x35, _x36) {
    ...
    value: function () {
      var _getAvailableDeliveries = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee30() {
        return _regenerator().w(function (_context30) {
          while (1) switch (_context30.n) {
            case 0:
              return _context30.a(2, this.proxyRequest('delivery', 'GET', '/api/deliveries/available'));
          }
        }, _callee30, this);
      }));
    ...
    value: function () {
      var _getDriverHistory = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee31(driverId) {
        return _regenerator().w(function (_context31) {
          while (1) switch (_context31.n) {
            case 0:
              return _context31.a(2, this.proxyRequest('delivery', 'GET', "/api/deliveries/driver/".concat(driverId, "/history")));
          }
        }, _callee31, this);
      }));
      function getDriverHistory(_x37) {
    ...
    key: "assignDelivery",
    value: function () {
      var _assignDelivery = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee32(deliveryId, driverId) {
        return _regenerator().w(function (_context32) {
          while (1) switch (_context32.n) {
            case 0:
              return _context32.a(2, this.proxyRequest('delivery', 'PATCH', "/api/deliveries/".concat(deliveryId, "/assign"), {
                driverId: driverId
              }));
          }
        }, _callee32, this);
      }));
      function assignDelivery(_x38, _x39) {
    ...
    key: "markArrived",
    value: function () {
      var _markArrived = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee33(deliveryId) {
        return _regenerator().w(function (_context33) {
          while (1) switch (_context33.n) {
            case 0:
              return _context33.a(2, this.proxyRequest('delivery', 'PATCH', "/api/deliveries/".concat(deliveryId, "/arrived"), {}));
          }
        }, _callee33, this);
      }));
      function markArrived(_x40) {
    ...
    key: "markPicked",
    value: function () {
      var _markPicked = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee34(deliveryId) {
        return _regenerator().w(function (_context34) {
          while (1) switch (_context34.n) {
            case 0:
              return _context34.a(2, this.proxyRequest('delivery', 'PATCH', "/api/deliveries/".concat(deliveryId, "/picked"), {}));
          }
        }, _callee34, this);
      }));
      function markPicked(_x41) {
    ...
    value: function () {
      var _completeDeliveryRequest = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee35(deliveryId) {
        return _regenerator().w(function (_context35) {
          while (1) switch (_context35.n) {
            case 0:
              return _context35.a(2, this.proxyRequest('delivery', 'PATCH', "/api/deliveries/".concat(deliveryId, "/complete"), {}));
          }
        }, _callee35, this);
      }));
      function completeDeliveryRequest(_x42) {
